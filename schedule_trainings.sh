...
declare -a trainings=(
    ...
    "configs/deeplabv3plus/deeplabv3plus_r50-d8_8xb1-30k_1024x1024_syn_v6_ohem_loss_dilated_masks.py;/netscratch/naeem/mmseg_output/eccv_results/Deeplabv3Plus_r50_syn_ohem_loss_dilated_masks"
